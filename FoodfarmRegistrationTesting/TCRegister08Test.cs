...
namespace FoodfarmRegistrationTesting
{
    ...
    public class TCRegister08Test
    {
        ...
        public void tCRegister08()
        {
            ...
            driver.FindElement(By.Id("ContentPlaceHolder1_txtRAddress")).SendKeys("Binh Duong");
            driver.FindElement(By.Id("ContentPlaceHolder1_txtRPhone")).Click();
            driver.FindElement(By.Id("ContentPlaceHolder1_txtRPhone")).SendKeys("0182938475");
            ...
            driver.FindElement(By.CssSelector(".lost_password")).Click();
            Assert.That(driver.FindElement(By.Id("ContentPlaceHolder1_hlRegister")).Text.ToString(), Is.EqualTo("Username already exists!"));
        }
    }
