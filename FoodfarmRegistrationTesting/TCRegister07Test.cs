...
namespace FoodfarmRegistrationTesting
{
    ...
    public class TCRegister07Test
    {
        ...
        public void tCRegister07()
        {
            ...
            Assert.That(driver.FindElement(By.Id("ContentPlaceHolder1_RequiredFieldValidator5")).Text, Is.EqualTo("Please enter your Password"));
