...
namespace FoodfarmRegistrationTesting
{
    ...
    public class TCRegister09Test
    {
        ...
        public void tCRegister09()
        {
            ...
            driver.FindElement(By.Id("ContentPlaceHolder1_txtRName")).SendKeys("HoangSang");
            ...
            driver.FindElement(By.Id("ContentPlaceHolder1_txtRPhone")).SendKeys("0162738492");
            driver.FindElement(By.Id("ContentPlaceHolder1_txtRUser")).Click();
            driver.FindElement(By.Id("ContentPlaceHolder1_txtRUser")).SendKeys("HoangSang");
